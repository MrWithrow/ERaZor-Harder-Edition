...
asm68k /e __WIDESCREEN__=1 /k /m /o ws+,op+,os+,ow+,oz+,oaq+,osq+,omq+,ae-,v+ /p sonic1.asm, s1erz_wideharder.bin, Debugger\Generated\s1erz_wide.sym, Debugger\Generated\s1erz_wide.lst

echo.
echo ============================================
if exist s1erz_wideharder.bin (
	...
	Debugger\convsym.exe Debugger/Generated/s1erz_wide.symbols.log s1erz_wideharder.bin -in log -a -range 0 FFFFFF
