...
asm68k /k /m /o ws+,op+,os+,ow+,oz+,oaq+,osq+,omq+,ae-,v+ /p sonic1.asm, s1erzharder.bin, Debugger\Generated\s1erz.sym, Debugger\Generated\s1erz.lst
...
if exist s1erzharder.bin (
	...
	Debugger\convsym.exe Debugger/Generated/s1erz.symbols.log s1erzharder.bin -in log -a -range 0 FFFFFF
